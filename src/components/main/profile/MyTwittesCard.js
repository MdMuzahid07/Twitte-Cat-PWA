...
import CardBottomNav from '../home/CardBottomNav';
import CardThreeDot from '../home/CardThreeDot';

const MyTwittesCard = () => {
    return (
        <div>
            <div className="my-5">
                <p className="font-bold text-blue-400 pl-3">My MeowIttes</p>
            </div>
